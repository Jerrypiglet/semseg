...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        loss_train, mIoU_train, mAcc_train, allAcc_train = train(train_loader, model, optimizer, epoch, epoch_log, val_loader, criterion)
        if main_process():
...
def train(train_loader, model, optimizer, epoch, epoch_log, val_loader, criterion):
